...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('social', '0006_auto_20191111_1907'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='userinfo',
            name='time',
            field=models.DateTimeField(auto_now=True, verbose_name='User Creation Time'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='website',
